  ...
  items.forEach((item) => {
    ...
    Term.getByName(item.name, (err, terms) => {
      ...
      if (terms != null && terms.length > 0) {
        ...
        Term.create(data_to_add, (err, term) => {
...
const base_url = 'http://api.stackexchange.com/2.2/tags?pagesize=100&order=desc&sort=popular&site=stackoverflow&filter=!bEvCQepmjja-QK';
