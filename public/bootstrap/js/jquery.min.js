...
!(function (a, b) { typeof module === 'object' && typeof module.exports === 'object' ? module.exports = a.document ? b(a, !0) : function (a) { if (!a.document) throw new Error('jQuery requires a window with a document'); return b(a); } : b(a); }(typeof window !== 'undefined' ? window : this, (a, b) => {
  var c = [],
    ...
    isNumeric(a) { return !m.isArray(a) && a - parseFloat(a) >= 0; },
    ...
    let b,
      ...
      let b,
        ...
        g = e.defaultView; return e !== n && e.nodeType === 9 && e.documentElement ? (n = e, o = e.documentElement, p = !f(e), g && g !== g.top && (g.addEventListener ? g.addEventListener('unload', () => { m(); }, !1) : g.attachEvent && g.attachEvent('onunload', () => { m(); })), c.attributes = ib(a => a.className = 'i', !a.getAttribute('className')), c.getElementsByTagName = ib(a => a.appendChild(e.createComment('')), !a.getElementsByTagName('*').length), c.getElementsByClassName = $.test(e.getElementsByClassName) && ib(a => a.innerHTML = "<div class='a'></div><div class='a i'></div>", a.firstChild.className = 'i', a.getElementsByClassName('i').length === 2), c.getById = ib(a => o.appendChild(a).id = u, !e.getElementsByName || !e.getElementsByName(u).length), c.getById ? (d.find.ID = function (a, b) { if (typeof b.getElementById !== C && p) { const c = b.getElementById(a); return c && c.parentNode ? [c] : []; } }, d.filter.ID = function (a) { const b = a.replace(cb, db); return function (a) { return a.getAttribute('id') === b; }; }) : (delete d.find.ID, d.filter.ID = function (a) { const b = a.replace(cb, db); return function (a) { const c = typeof a.getAttributeNode !== C && a.getAttributeNode('id'); return c && c.value === b; }; }), d.find.TAG = c.getElementsByTagName ? function (a, b) { return typeof b.getElementsByTagName !== C ? b.getElementsByTagName(a) : void 0; } : function (a, b) {
        let c,
          d = [],
          e = 0,
      ...
      preFilter: {
        ...
        CHILD(a) { return a[1] = a[1].toLowerCase(), a[1].slice(0, 3) === 'nth' ? (a[3] || fb.error(a[0]), a[4] = +(a[4] ? a[5] + (a[6] || 1) : 2 * (a[3] === 'even' || a[3] === 'odd')), a[5] = +(a[7] + a[8] || a[3] === 'odd')) : a[3] && fb.error(a[0]), a; },
        PSEUDO(a) {
          let b,
      ...
      filter: {
        ...
        CLASS(a) { let b = y[`${a} `]; return b || (b = new RegExp(`(^|${M})${a}(${M}|$)`)) && y(a, a => b.test(typeof a.className === 'string' && a.className || typeof a.getAttribute !== C && a.getAttribute('class') || '')); },
        ATTR(a, b, c) { return function (d) { let e = fb.attr(d, a); return e == null ? b === '!=' : b ? (e += '', b === '=' ? e === c : b === '!=' ? e !== c : b === '^=' ? c && e.indexOf(c) === 0 : b === '*=' ? c && e.indexOf(c) > -1 : b === '$=' ? c && e.slice(-c.length) === c : b === '~=' ? (` ${e} `).indexOf(c) > -1 : b === '|=' ? e === c || e.slice(0, c.length + 1) === `${c}-` : !1) : !0; }; },
        CHILD(a, b, c, d, e) {
        ...
        PSEUDO(a, b) {
          let c,
            e = d.pseudos[a] || d.setFilters[a.toLowerCase()] || fb.error(`unsupported pseudo: ${a}`); return e[u] ? e(b) : e.length > 1 ? (c = [a, a, '', b], d.setFilters.hasOwnProperty(a.toLowerCase()) ? hb((a, c) => {
            let d,
              f = e(a, b),
      ...
      pseudos: {
        ...
        has: hb(a => function (b) { return fb(a, b).length > 0; }),
        contains: hb(a => function (b) { return (b.textContent || b.innerText || e(b)).indexOf(a) > -1; }),
        lang: hb(a => W.test(a || '') || fb.error(`unsupported lang: ${a}`), a = a.replace(cb, db).toLowerCase(), (b) => { let c; do if (c = p ? b.lang : b.getAttribute('xml:lang') || b.getAttribute('lang')) return c = c.toLowerCase(), c === a || c.indexOf(`${a}-`) === 0; while ((b = b.parentNode) && b.nodeType === 1);return !1; }),
        ...
        even: nb((a, b) => { for (let c = 0; b > c; c += 2)a.push(c); return a; }),
        odd: nb((a, b) => { for (let c = 1; b > c; c += 2)a.push(c); return a; }),
        lt: nb((a, b, c) => { for (let d = c < 0 ? c + b : c; --d >= 0;)a.push(d); return a; }),
        gt: nb((a, b, c) => { for (let d = c < 0 ? c + b : c; ++d < b;)a.push(d); return a; }),
      },
    }, d.pseudos.nth = d.pseudos.eq; for (b in {
      radio: !0, checkbox: !0, file: !0, password: !0, image: !0,
    })d.pseudos[b] = lb(b); for (b in { submit: !0, reset: !0 })d.pseudos[b] = mb(b); function pb() {}pb.prototype = d.filters = d.pseudos, d.setFilters = new pb(), g = fb.tokenize = function (a, b) {
      let c,
        e,
        f,
        g,
    ...
    }, c.sortStable = u.split('').sort(B).join('') === u, c.detectDuplicates = !!l, m(), c.sortDetached = ib(a => 1 & a.compareDocumentPosition(n.createElement('div'))), ib(a => a.innerHTML = "<a href='#'></a>", a.firstChild.getAttribute('href') === '#') || jb('type|href|height|width', (a, b, c) => (c ? void 0 : a.getAttribute(b, b.toLowerCase() === 'type' ? 1 : 2))), c.attributes && ib(a => a.innerHTML = '<input/>', a.firstChild.setAttribute('value', ''), a.firstChild.getAttribute('value') === '') || jb('value', (a, b, c) => (c || a.nodeName.toLowerCase() !== 'input' ? void 0 : a.defaultValue)), ib(a => a.getAttribute('disabled') == null) || jb(L, (a, b, c) => { let d; return c ? void 0 : a[b] === !0 ? b.toLowerCase() : (d = a.getAttributeNode(b)) && d.specified ? d.value : null; }), fb;
  ...
  }, (a, b) => { m.fn[a] = function (c, d) { let e = m.map(this, b, c); return a.slice(-5) !== 'Until' && (d = c), d && typeof d === 'string' && (e = m.filter(d, e)), this.length > 1 && (C[a] || (e = m.unique(e)), B.test(a) && (e = e.reverse())), this.pushStack(e); }; }); let E = /\S+/g,
  ...
  }), nc = { set(a, b, c) { return b === !1 ? m.removeAttr(a, c) : rc && qc || !pc.test(c) ? a.setAttribute(!qc && m.propFix[c] || c, c) : a[m.camelCase(`default-${c}`)] = a[c] = !0, c; } }, m.each(m.expr.match.bool.source.match(/\w+/g), (a, b) => {
  ...
  }), m.each(['ajaxStart', 'ajaxStop', 'ajaxComplete', 'ajaxError', 'ajaxSuccess', 'ajaxSend'], (a, b) => { m.fn[b] = function (a) { return this.on(b, a); }; }), m._evalUrl = function (a) {
    return m.ajax({
  ...
  }), m.expr.filters.hidden = function (a) { return a.offsetWidth <= 0 && a.offsetHeight <= 0 || !k.reliableHiddenOffsets() && (a.style && a.style.display || m.css(a, 'display')) === 'none'; }, m.expr.filters.visible = function (a) { return !m.expr.filters.hidden(a); }; let Qc = /%20/g,
    Rc = /\[\]$/,
    Sc = /\r?\n/g,
    ...
    Xc = {},
    Yc = m.ajaxSettings.xhr(); a.ActiveXObject && m(a).on('unload', () => { for (const a in Xc)Xc[a](void 0, !0); }), k.cors = !!Yc && 'withCredentials' in Yc, Yc = k.ajax = !!Yc, Yc && m.ajaxTransport((a) => {
  ...
  }, m.expr.filters.animated = function (a) { return m.grep(m.timers, b => a === b.elem).length; }; const cd = a.document.documentElement; function dd(a) { return m.isWindow(a) ? a : a.nodeType === 9 ? a.defaultView || a.parentWindow : !1; }m.offset = {
    setOffset(a, b, c) {
      let d,
        e,
        f,
  ...
  }), m.fn.size = function () { return this.length; }, m.fn.andSelf = m.fn.addBack, typeof define === 'function' && define.amd && define('jquery', [], () => m); let ed = a.jQuery,
